...
<html lang="en" class="no-js">
	...
	<?php 
		...
		<header class="header">
			<h1 class="header__title"><a href="../index1.php">Trang chủ</a></h1>&nbsp &nbsp
			<h1 class="header__title">Xem trước chỗ ngồi trong rạp</h1>
			<p class="note note--screen">Vui lòng xem trên màn hình lớn.</p>
			<p class="note note--support">Xin lỗi, nhưng trình duyệt của bạn không hỗ trợ secure-3d!</p>
		</header>
		<div class="container">
			<div class="cube">
					...
					<div class="screen">
						<div class="video">
							<video class="video-player" src="media/logo.mp4" preload="auto" poster="media/logo5.png">
								...
								<p>Xin lỗi, nhưng trình duyệt của bạn không hỗ trợ định dạng video này.</p>
							</video>
						...
						<div class="intro intro--shown">
							<div class="intro__side">
								<h2 class="intro__title">
									<span class="intro__up">Group 2</span>
									<span class="intro__down">Group <span class="intro__partial">2</span></span>
								</h2>
							</div>
							<div class="intro__side">
								<button class="action action--seats">Chọn ghế</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="plan">
			<h3 class="plan__title">Chọn ghế</h3>
			...
			<!-- /rows -->
			<ul class="legend">
				<li class="legend__item legend__item--free">Ghế trống</li>
				<li class="legend__item legend__item--reserved">Đảm bảo giãn cách</li>
				<li class="legend__item legend__item--selected">Đã chọn</li>
			</ul>
			
			<!-- <div id='display' style="font-family: 'Poppins', sans-serif; margin-left: 40%; margin-bottom:3% "></div>
									   -->
			 <a href="../booking.php?movie_id=<?php echo $_SESSION['movie_id'];?>"> <button   class="action action--buy" name='submit'>Mua vé </button></a>

			<!-- <button class="action action--buy">Buy tickets</button> -->
			<p class="header__title">Trải nghiệm Chế độ xem 3-D <br>
