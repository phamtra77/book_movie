...
<style>
    ...
    <div class="container">
        <h1 class="mt-4 mb-3" style="font-family: 'Poppins', sans-serif;">Đánh giá và xếp hạng của người xem</h1>
...
<p class="card-text"style="padding-left: 10px"><b>Đánh giá:</b> &nbsp <?php echo $record['rating']; ?>⭐</p>
<p class="card-text"style="padding-left: 10px"><b>Nhận xét:</b> &nbsp <?php echo $record['review']; ?></p>
